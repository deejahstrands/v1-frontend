...
interface CustomizationMeasurementsProps {
  className?: string;
}

export const CustomizationMeasurements: React.FC<CustomizationMeasurementsProps> = ({
  className
}) => {
  const { data, setField } = useCustomizationMeasurements();
      ...
      <div className="bg-white rounded-xl p-6 border border-[#98A2B3] w-full max-w-md mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            Fill out these details to build your customized wig
          </p>
        </div>
