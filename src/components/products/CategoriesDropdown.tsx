  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center cursor-pointer gap-1 px-4 py-2 rounded-md bg-white text-sm font-semibold border border-gray-200 hover:bg-gray-100 transition">
      ...
      <DropdownMenuContent align="start" className="w-64 py-2 bg-white border border-gray-200">
        <div className="flex items-center justify-between mb-2 px-2">
          ...
          <button className="text-xs text-primary hover:underline cursor-pointer" onClick={onReset} type="button">Reset</button>
        </div>
        <hr className="my-2" />
