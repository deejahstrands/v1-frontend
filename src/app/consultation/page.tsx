...
export default function ConsultationPage() {
  ...
  const handleAddToCart = () => {
    ...
    // Create a cart item for the consultation
    const consultationItem = {
      productId: `consultation-${selectedConsultation.id}`,
      title: `Wig Consultation - ${selectedConsultation.name}`,
      basePrice: selectedConsultation.price,
      customizations: {},
      customizationTotal: 0,
      totalPrice: selectedConsultation.price,
      quantity: 1,
      consultation: {
    ...
    console.log('Added consultation to cart:', consultationItem);
  };
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="text-sm font-semibold">₦{type.price.toLocaleString()}</span>
                        </div>
                ...
                {selectedConsultation && (
                  <div className="mt-4 p-3 bg-secondary/5 rounded-lg border border-secondary/20">
                    ...
                    <div className="text-xs text-gray-600">
                      Price: ₦{selectedConsultation.price.toLocaleString()}
                    </div>
                  </div>
                )}
              </motion.div>
                  ...
                  {showSuccess && (
                    <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                      <p className="text-sm text-green-700 text-center">
                        ✓ Consultation added to cart successfully!
                      </p>
                    </div>
                  )}
